...
//
//
//        public tipoAnimal(int altura, double peso, int edad, String tipoAnimal) {
...
//
//        public mamifero(int altura, double peso, int edad, String tipoAnimal) {
...
//
//        public ave(int altura, double peso, int edad, String tipoAnimal) {
//            super(altura, peso, edad, tipoAnimal);
//            getDetails();
//
//        }
...
//        protected String desplazamiento = "vuelan";
//
//        public pez(int altura, double peso, int edad, String tipoAnimal) {
//            super(altura, peso, edad, tipoAnimal);
//            getDetails();
//        }
//
...
//
//        public perro(int altura, double peso, int edad, String nombreCientifico, String nombre, String raza, String terreno) {
//            super(altura, peso, edad);
...
//        protected String terreno;
//        protected String nombre;
//        public caballo (int altura, double peso, int edad, String tipoAnimal, String nombreCientifico, String nombre, String raza, String terreno) {
//            super(altura, peso, edad, tipoAnimal);
//            this.nombreCientifico=nombreCientifico;
//            this.nombre=nombre;
//            this.raza=raza;
